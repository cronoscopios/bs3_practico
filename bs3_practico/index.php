...
<head>
	...
	<title>Workshops con Bootstraps 3</title>
</head>
<body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-9 col-md-8 col-lg-6 main-info">
						<h2>Desarrolla aplicaciones multiplataformas con Adobe AIR</h2>
						<p>Sorpréndete de lo fácil que puede ser crear apps para iOS y 
						Android con este workshop impartido por <a href="#">Alberto Ordás</a>.
						</p>
						<a href="detail.php" class="more-info-link">Quiero mas información</a>
						<a href="detail.php" class="btn btn-custom">ME APUNTO!</a>
					</div>
